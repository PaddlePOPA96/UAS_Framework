<?php $__env->startSection('content'); ?>
    <div class="container mt-4">
        ...
        <div class="table-responsive border p-3 rounded-3">
            <table class="table table-bordered table-hover table-striped mb-5 bg-white datatable" id="employeeTable">
                <thead>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\fariduta\Documents\Framework\uAS\fitur_pihak-ketiga_laravel\resources\views/employee/index.blade.php ENDPATH**/ ?>